    ...
    const items: MenuItem[] = [
        {
            ...
            children: [
                { key: 'auto',
                  label: (
                    <Checkbox onChange={checkCategory} value={"auto"} checked={selectedCategories.includes("auto")}>Авто</Checkbox>
                  )    
                },
                { key: 'electronics',
                  label: (
                    <Checkbox onChange={checkCategory} value="electronics" checked={selectedCategories.includes("electronics")}>Электроника</Checkbox>
                  )    
                },
                { key: 'real_estate',
                  label: (
                    <Checkbox onChange={checkCategory} value="real_estate" checked={selectedCategories.includes("real_estate")}>Недвижимость</Checkbox>
                  )    
                },
            ],
        }
  ...
  return (
    <>
        <Flex vertical style={{gap: 10}}>
          ...
          <Button onClick={clearCategories} style={{border: "none", width: "100%", padding: "20px 0"}}>Сбросить фильтры</Button>
        </Flex>       
    </>
