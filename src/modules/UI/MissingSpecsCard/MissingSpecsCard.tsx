...
const MissingSpecsCard = ({missingSpecs}: {missingSpecs: string[]}) => {
  ...
  return (
    <Card styles={{ root: {backgroundColor: bgGold, padding: "12px 16px", borderRadius: 8, boxShadow: "0px 9px 28px 8px rgba(0, 0, 0, 0.05), 0px 6px 16px 0px rgba(0, 0, 0, 0.08), 0px 3px 6px -4px rgba(0, 0, 0, 0.12)"}, body: { padding: 0 } }}>
        <Card.Meta
            avatar={<ExclamationCircleFilled style={{color: textGold, fontSize: 18}}/>} 
